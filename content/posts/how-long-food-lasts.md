...
What a chart like this is for is not needing to guess in the first place. Pantry is built to keep this same dataset behind every item a receipt adds, so the expiry date on the list is this table, not a memory of it. The [receipt scanning post](/resources/receipt-to-meals) has the detail on how that works, and the [household food waste numbers](/resources/household-food-waste-by-the-numbers) explain why a few days one way or the other adds up to real money over a year.
